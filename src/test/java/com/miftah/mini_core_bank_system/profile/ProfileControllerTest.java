...
public class ProfileControllerTest {
    ...
    void create_DuplicateFields_ShouldReturnBadRequest() throws Exception {
        ...
        mockMvc.perform(post("/api/profiles")
                ...
                .andExpect(jsonPath("$.errors").value(containsString("identityNumber: Identity number already exists")))
                .andExpect(jsonPath("$.errors").value(containsString("phone: Phone number already exists")));
    }
